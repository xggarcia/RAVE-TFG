...
from src.streaming_gui._slot_phase_mixin import _SlotInputsMixin


class StreamGUISlotWidgetsMixin(_SlotInputsMixin):
    @staticmethod
    ...
    def create_model_slot_ui(self, slot):
        ...
        self._build_input_controls(slot_frame, slot)
